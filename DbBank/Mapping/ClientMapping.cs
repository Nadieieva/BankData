...
namespace BankDb.Mapping
{
    public class ClientMapping: EntityTypeConfiguration<Client>
    {
        public ClientMapping()
        {
            ...
            Property(c => c.Birthday).HasColumnName("Birthday").HasColumnType("date").IsRequired();
            Property(c => c.Phone).HasColumnName("Phone").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(20);
